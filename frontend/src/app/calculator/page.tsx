...
import { Calculator, ArrowRight, Info, CreditCard, Smartphone, LogIn, UserRoundX } from 'lucide-react';
                  ...
                  <div className="pt-4 border-t">
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                      <div className="rounded-lg border bg-muted/30 p-4 space-y-3">
                        <p className="text-sm text-muted-foreground">
                          Log masuk untuk rekod profil penuh dan resit cukai.
                        </p>
                        <Link href={`/auth/login?redirect=${encodeURIComponent(`/pay?amount=${result.zakat_due}&type=${zakatType}`)}`}>
                      ...
                      <div className="rounded-lg border border-primary/30 bg-primary/5 p-4 space-y-3">
                        <p className="text-sm text-muted-foreground">
                          Mahu cepat? Teruskan sebagai Hamba Allah tanpa daftar.
                        </p>
                        <Link href={`/checkout?amount=${result.zakat_due}&type=${zakatType}`}>
