 ...
 * LZS roles aligned with lzs-requirements.md
 */

import { create } from 'zustand';
import { persist, createJSONStorage } from 'zustand/middleware';

/** All LZS user roles per requirements */
...
/** Amil sub-type: PAF, PAP, PAL */
export type AmilType = 'paf' | 'pap' | 'pal';

/** Agent sub-type */
export type AgentType = 'ipis' | 'ipt' | 'consultant';
...
interface User {
  ...
  role: UserRole;
  is_verified: boolean;
  /** For amil: Penolong Amil Fitrah/Padi/Lapangan */
  amil_type?: AmilType;
  /** For agent: IPIS, IPT, Consultant */
