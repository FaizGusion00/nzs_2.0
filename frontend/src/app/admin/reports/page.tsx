...
import { Download, FileText, CalendarRange, TrendingUp, Building2, CreditCard, Users, BarChart3, LineChart } from 'lucide-react';
...
export default function AdminReportsPage() {
  ...
  const handleExport = (format: 'pdf' | 'excel' | 'csv') => {
    ...
    alert(`Demo: Eksport ${reportType} sebagai ${format.toUpperCase()}.\n\nUntuk CSV, fail telah dimuat turun dengan columns penting.`);
  };
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      (Demo) Penapisan menggunakan data mock.
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <TabsContent value="custom" className="mt-0">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Self-service: Pilih penapis, kolum dan format eksport
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-medium">Penapis</label>
                      <div className="flex flex-wrap gap-2 mt-2">
                        <Button variant="outline" size="sm">Jenis Zakat</Button>
                        <Button variant="outline" size="sm">Cawangan</Button>
                        <Button variant="outline" size="sm">Kaedah Bayaran</Button>
                        <Button variant="outline" size="sm">Julat Tarikh</Button>
                      </div>
                    </div>
                    <div>
                      <label className="text-sm font-medium">Kolum untuk Eksport</label>
                      <div className="flex flex-wrap gap-2 mt-2">
                        <Button variant="outline" size="sm">No. Rujukan</Button>
                        <Button variant="outline" size="sm">Nama Pembayar</Button>
                        <Button variant="outline" size="sm">Jumlah</Button>
                        <Button variant="outline" size="sm">Tarikh</Button>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Exploratory Data Analysis: Taburan mengikut jenis zakat dan saluran
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-48 flex items-center justify-center border rounded bg-muted/30 text-muted-foreground text-sm">
                      Carta taburan (mock): Zakat Pendapatan 45%, Perniagaan 35%, Emas 12%, Lain 8%
                    </div>
                  </CardContent>
                </Card>
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center">
                      ...
                      Ramalan Ramadan / Disember
                    </CardTitle>
                    <CardDescription>
                      Predictive Analytics: Anggaran puncak kutipan (ML/AI mock)
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-2 text-sm">
                      <p><strong>Ramadan 2025:</strong> Anggaran +180% vs purata bulanan</p>
                      <p><strong>Disember 2025:</strong> Anggaran +95% vs purata bulanan</p>
                      <p className="text-muted-foreground text-xs mt-2">
                        (Demo) Model ramalan akan diintegrasi dengan data sejarah sebenar.
                      </p>
                    </div>
                  </CardContent>
                </Card>
