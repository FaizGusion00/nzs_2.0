...
const profileSchema = z.object({
  ...
  doc_type: z.enum(['ic', 'passport']),
  doc_number: z.string().min(1, 'Sila masukkan nombor dokumen'),
        ...
        <div className="container max-w-7xl mx-auto">
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              (Demo) Pengesahan pendua: Sistem akan semak IC/Passport terhadap rekod sedia ada.
            </p>
          </div>
              ...
              <Card>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label>Dokumen Pengenalan</Label>
                      <Tabs value={docType} onValueChange={(v) => setValue('doc_type', v as 'ic' | 'passport')} className="w-full">
                        <TabsList className="grid w-full grid-cols-2">
                          <TabsTrigger value="ic">MyKad / No. IC</TabsTrigger>
                          <TabsTrigger value="passport">No. Passport</TabsTrigger>
                        </TabsList>
                        <TabsContent value="ic" className="mt-2">
                          <Input
                            placeholder="900101011234"
                            {...register('doc_number')}
                            disabled={isLoading}
                          />
                          <p className="text-xs text-muted-foreground mt-1">Format: 12 digit tanpa dash</p>
                        </TabsContent>
                        <TabsContent value="passport" className="mt-2">
                          <Input
                            ...
                            disabled={isLoading}
                          />
                          <p className="text-xs text-muted-foreground mt-1">No. passport boleh dikemas kini jika berubah</p>
                        </TabsContent>
                      </Tabs>
                      {errors.doc_number && (
                        <p className="text-sm text-destructive">{errors.doc_number.message}</p>
                      )}
                    </div>
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  {user.role === 'payer_individual' && (
                    <Link href="/profile/spg">
